...
const useKotDelete = ({onOpenChange,onResetToAdd}:Props) => {
    ...
    const onDelete = async (id: string | undefined) => {
        ...
        try {
            ...
            const response = await axiosInstance.delete(`${apiEndpoints.kot.delete}/${id}`);
    ...
    // Return the delete kot function and the current error message for use within the component
    return { onDelete, errorMessage };
};

export default useKotDelete;
