...
const useCategoryDelete = ({onOpenChange,onResetToAdd}:Props) => {
    ...
    const onDelete = async (id: string | undefined) => {
        ...
        try {
            ...
            const response = await axiosInstance.delete(`${apiEndpoints.category.delete}/${id}`);
    ...
    // Return the delete category function and the current error message for use within the component
